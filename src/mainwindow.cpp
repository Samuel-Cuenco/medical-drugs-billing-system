...
void MainWindow::checkout() {
    ...
    PaymentDialog diag(originalTotal, this);
    ...
    QSqlQuery tQuery;
    tQuery.prepare("INSERT INTO transactions (total_amount, received, change_amount, discount_amount, discount_type) VALUES (:t, :r, :c, :da, :dt)");
